  ...
  <div>
    ...
    <v-container v-if="resultList.length === 1" class="nanumG-20">
      <v-row class="d-flex justify-center align-center jua-25">
        <v-chip color="blue lighten-2" class="mx-5" style="color: white;">
    ...
    <v-container v-else class="text-center">
      <v-row v-for="studentIndex in Math.ceil(resultList.length / 2)" :key="studentIndex">
        <v-col cols="6">
          <v-container class="studentCard">
            {{ resultList[(studentIndex - 1) * 2]}}
          </v-container>
        </v-col>
        <v-col cols="6">
          <v-container class="studentCard">
            {{ resultList[(studentIndex - 1) * 2 + 1]}}
          </v-container>
        </v-col>
      </v-row>
    </v-container>
