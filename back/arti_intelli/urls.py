...
urlpatterns = [
    ...
    path('checks/notout/<int:pk>/', views.not_outclick, name="not_outclick"),
    path('checks/notin/<int:pk>/', views.not_inclick, name="not_inclick"),
    path('checks/<int:pk>/', views.check_on_region, name="check_on_region"),
